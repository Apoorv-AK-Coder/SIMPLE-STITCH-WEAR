...
function checkServer(monitor, callback) {
    ...
    (0, connect_1.connect)(monitor.connectOptions, (err, conn) => {
        ...
        if (conn) {
            ...
            monitor.emitAndLogHeartbeat(server_1.Server.SERVER_HEARTBEAT_SUCCEEDED, monitor[kServer].topology.s.id, conn.hello?.connectionId, new events_1.ServerHeartbeatSucceededEvent(monitor.address, (0, utils_1.calculateDurationInMs)(start), conn.hello, useStreamingProtocol(monitor, conn.hello?.topologyVersion)));
